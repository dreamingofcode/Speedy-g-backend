...
public class ReviewResource {
    ...
    //this gives me a bad request error not sure why?
...
///Attempted TO CREATE GET FOR INDIVIDUAL REVIEW USING ID
    @GetMapping(path="{id}")
  ...
  return review;}
    ...
    ///BOTH METHODS INVOLVE THE DAO SERVICE.
...
//    @PutMapping(path="{id}")
//    public void updateUser( @PathVariable("id") int id,@NonNull @RequestBody Review userToUpdate){
//        ReviewDAOService.updateUser(id, userToUpdate);
//    }
}
